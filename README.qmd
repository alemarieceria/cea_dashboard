...
Open the project in desired IDE (I use Positron), then run to recreate the exact R package environment recorded in `renv.lock`:
...
* [Workflow Conventions Notes](https://github.com/alemarieceria/cea_dashboard/tree/main/docs/workflow_conventions.md)
